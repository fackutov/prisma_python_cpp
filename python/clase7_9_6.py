...
while True: # inicio del bucle
    ...
    if opcion == 0:
        ...
        if nro_codigo < 99:
            ...
            nuevo_codigo = letra_codigo + '-' + str(nuevo_numero).rjust(2,'0') # creo un nuevo codigo (ej: A-03, B-45, D-12)
            pausar02()
            ...
            if lista_letras.index(letra_codigo) == len(lista_letras)-1: # en caso de que el uktimo numero sea 99 verifico si la letra es la ultiam de mi lista de letras
        ...
        if len(lista_pacientes) == 0:
            ...
            pausar02()
            print(f'paciente {lista_pacientes[0]} atendido')
...
# creo que funciona pero aun no lo he probado del todo